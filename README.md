...
- **Direct MSB-Aligned Passthrough** — Host 24-in-32-bit PCM stream is fed directly into the audio DMA engine without software scaling, bit-shift truncation, or digital filtering.
...
To monitor real-time playback and buffer telemetry:
```bash
